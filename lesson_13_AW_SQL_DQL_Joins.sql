...
FROM databricks_ml.default.dim_product               p
INNER JOIN databricks_ml.default.dim_product_subcategory      psc
...
FROM       databricks_ml.default.dim_product                 p
LEFT JOIN databricks_ml.default.dim_product_subcategory      psc
ON (p.ProductSubcategoryKey = psc.ProductSubcategoryKey)
...
SELECT      p.ProductKey, p.EnglishProductName as Product, psc.EnglishProductSubcategoryName as Subcategory 
FROM        default.dim_product_subcategory                 psc
RIGHT JOIN  default.dim_product                            p
...
select EnglishProductSubcategoryName from  default.dim_product_subcategory limit 5
...
FROM       default.dim_product                 p
FULL OUTER JOIN default.dim_product_subcategory      psc
ON (p.ProductSubcategoryKey = psc.ProductSubcategoryKey)
...
-- , psc.EnglishProductSubcategoryName as Subcategory 
FROM           default.dim_product                 p
LEFT SEMI JOIN default.dim_product_subcategory      psc
ON (p.ProductSubcategoryKey = psc.ProductSubcategoryKey)
LIMIT 3
...
select EnglishProductCategoryName from  default.dim_product_category
...
FROM        default.dim_product_category     c
CROSS JOIN  default.dim_product_subcategory  sc
...
SELECT     p.ProductKey, p.EnglishProductName as Product, p.ProductSubcategoryKey
FROM       default.dim_product                 p
ANTI JOIN  default.dim_product_subcategory      psc
ON (p.ProductSubcategoryKey = psc.ProductSubcategoryKey)
